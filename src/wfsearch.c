...
//
/////////////////////////////////////////////////////////////////////
INT SearchList(HWND hwndLB, LPWSTR szPath, LPWSTR szFileSpec, BOOL bRecurse, 
    BOOL bIncludeSubdirs, LPXDTALINK* plpStart, INT iFileCount, BOOL bRoot)
{
    INT iRetVal;
    SIZE size;
    BOOL bFound;
...
//
/////////////////////////////////////////////////////////////////////
LRESULT CALLBACK SearchWndProc( register HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    INT  iSel;
    HWND hwndLB;
